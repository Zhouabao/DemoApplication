...
import com.sdy.jitangapplication.nim.uikit.common.adapter.BaseAdapter;
import com.sdy.jitangapplication.nim.uikit.common.adapter.BaseDelegate;
import com.sdy.jitangapplication.nim.uikit.common.adapter.BaseViewHolder;
import com.sdy.jitangapplication.nim.uikit.common.adapter.ItemClickListerAdapter;
...
import com.sdy.jitangapplication.nim.uikit.common.media.imagepicker.view.SuperCheckBox;
...
public class ImagePreviewActivity extends ImagePreviewBaseActivity implements ImagePicker.OnImageSelectedListener,
    ...
    private void updateCheckState() {
        ...
        if (selectOrder > 0) {
            int pos = 0;
            for (com.sdy.jitangapplication.nim.uikit.common.media.model.GLImage GLImage : imagePicker.getSelectedImages()) {
