...
import com.sdy.jitangapplication.nim.uikit.common.media.imagepicker.adapter.ImagePageAdapter;
import com.sdy.jitangapplication.nim.uikit.common.media.imagepicker.adapter.LocalImagePageAdapter;
import com.sdy.jitangapplication.nim.uikit.common.media.imagepicker.view.ViewPagerFixed;
...
public class ImagePreviewRetakeActivity extends ImageBaseActivity implements View.OnClickListener {
    ...
    public static void start(Activity activity, GLImage GLImage) {
        List<com.sdy.jitangapplication.nim.uikit.common.media.model.GLImage> GLImages = new ArrayList<>(1);
