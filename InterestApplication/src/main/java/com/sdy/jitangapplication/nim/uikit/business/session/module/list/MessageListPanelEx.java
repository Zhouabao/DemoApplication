package com.sdy.jitangapplication.nim.uikit.business.session.module.list;
...
public class MessageListPanelEx {
    ...
    public MessageListPanelEx(Container container, View rootView, IMMessage anchor, boolean recordOnly,
                              boolean remote) {
            ...
            alertDialog.addItem(container.activity.getString(R.string.withdrawn_msg),
                    new CustomAlertDialog.onSeparateItemClickListener() {
                        ...
                        public void onClick() {
                            ...
                            // NIMClient.getService(MsgService.class).revokeMessage(item).setCallback(new
    ...
    private boolean sendReceiptCheck(final IMMessage msg) {
        return msg != null && msg.getDirect() == MsgDirectionEnum.In && msg.getMsgType() != MsgTypeEnum.tip
