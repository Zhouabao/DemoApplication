...
public class GLMediaPlayer {
    ...
    public void reset() {
        ...
        if (mStatus == PlayerState.PLAYER_STOPPED || mStatus == PlayerState.PLAYER_ERROR
                || mStatus == PlayerState.PLAYER_INIT) {
            mPlayer.reset();
    ...
    public void stop() {
        ...
        if (mStatus == PlayerState.PLAYER_PREPARED || mStatus == PlayerState.PLAYER_STARTED
                || mStatus == PlayerState.PLAYER_PAUSED || mStatus == PlayerState.PLAYER_PLAYBACK_COMPLETE) {
            mPlayer.stop();
    ...
    public void start() {
        ...
        if (mStatus == PlayerState.PLAYER_PREPARED || mStatus == PlayerState.PLAYER_PAUSED
                || mStatus == PlayerState.PLAYER_PLAYBACK_COMPLETE) {
            mPlayer.start();
    ...
    private int getCurrentPosition() {
        ...
        if (mStatus == PlayerState.PLAYER_STARTED || mStatus == PlayerState.PLAYER_PAUSED
                || mStatus == PlayerState.PLAYER_STOPPED || mStatus == PlayerState.PLAYER_PREPARED
                || mStatus == PlayerState.PLAYER_PLAYBACK_COMPLETE) {
