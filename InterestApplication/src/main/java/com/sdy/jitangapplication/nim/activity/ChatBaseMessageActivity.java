 ...
 */
public abstract class ChatBaseMessageActivity extends UI {
    ...
    protected abstract ChatMessageFragment fragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        messageFragment = (ChatMessageFragment) switchContent(fragment());
        if (enableSensor()) {
            initSensor();
        }
        ...
        for (final SessionCustomization.OptionsButton button : buttons) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    button.onClick(ChatBaseMessageActivity.this, v, sessionId);
                }
            });
    ...
    private SensorEventListener sensorEventListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (0.0f == dis[0]) {
                //靠近，设置为听筒模式
                MessageAudioControl.getInstance(ChatBaseMessageActivity.this).setEarPhoneModeEnable(true);
            } else {
                //离开，复原
                MessageAudioControl.getInstance(ChatBaseMessageActivity.this).setEarPhoneModeEnable(UserPreferences.isEarPhoneModeEnable());
            }
        }
