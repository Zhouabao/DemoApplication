...
public class ChatMessageListPanelEx {
    ...
    private class MsgItemEventListener implements ChatMsgAdapter.ViewHolderEventListener {
    ...
    private View initHeadView(boolean showLetftCardtimes) {
        ...
        targetSquareAdapter.setOnItemClickListener((adapter, view, position) -> SquareCommentDetailActivity.Companion
                .start(container.activity, null, targetSquareAdapter.getData().get(position).getId(), -1,SquareCommentDetailActivity.TYPE_SQUARE,1));
        return headView;
    }
