...
import kotlinx.android.synthetic.main.item_intention1.view.*

class MyIntentionAdapter1 : BaseQuickAdapter<LabelQualityBean, BaseViewHolder>(R.layout.item_intention1) {
