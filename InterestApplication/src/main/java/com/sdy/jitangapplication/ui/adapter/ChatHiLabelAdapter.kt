 ...
 *    version: 1.0
 */
class ChatHiLabelAdapter(context: Context) :
    BaseRecyclerViewAdapter<Tag, ChatHiLabelAdapter.ViewHolder>(context) {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.item_chat_hi_label, parent, false)
