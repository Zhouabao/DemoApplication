...
import com.sdy.jitangapplication.ui.adapter.MyIntentionAdapter1
import com.sdy.jitangapplication.utils.UserManager
import com.sdy.jitangapplication.widgets.DividerItemDecoration
import kotlinx.android.synthetic.main.activity_my_intention.intentionRv
import kotlinx.android.synthetic.main.activity_my_intention.stateIntention
import kotlinx.android.synthetic.main.activity_my_intention1.*
 ...
 * 我的意愿
 */
class MyIntentionActivity1 : BaseMvpActivity<MyIntentionPresenter>(), MyIntentionView {
    companion object {
        const val FROM_REGISTER = 1
        const val FROM_USERCENTER = 2
    }

    private val adapter by lazy { MyIntentionAdapter1() }
    private val checkedId by lazy { intent.getIntExtra("id", -1) }
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_my_intention1)
        initView()
