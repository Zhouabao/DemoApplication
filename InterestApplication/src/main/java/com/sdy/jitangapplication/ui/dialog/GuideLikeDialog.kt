...
import kotlinx.android.synthetic.main.dialog_guide_like.*
 ...
 *    version: 1.0
 */
class GuideLikeDialog(context: Context) : Dialog(context, R.style.MyDialog) {
    ...
    private fun initView() {
        ...
        intentionMatchingCl.onClick {
            ...
            UserManager.saveShowGuideLike(true)
            dismiss()
        }
    }
}