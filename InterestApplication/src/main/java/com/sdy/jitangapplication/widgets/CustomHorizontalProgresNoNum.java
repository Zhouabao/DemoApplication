...
public class CustomHorizontalProgresNoNum extends ProgressBar {
    ...
    private static final int DEAFUALT_PROGRESS_RADIUS = 10;//dp
    ...
    protected int HorizontalProgresRadius;
    ...
    protected void getStyleabletAttr(AttributeSet attrs) {
        ...
        HorizontalProgresRadius = (int) typedArray.getDimension(R.styleable.CustomHorizontalProgresStyle_HorizontalProgresRadius, dp2px(getContext(), DEAFUALT_PROGRESS_RADIUS));
        rids = new float[]{HorizontalProgresRadius, HorizontalProgresRadius, HorizontalProgresRadius, HorizontalProgresRadius,
                HorizontalProgresRadius, HorizontalProgresRadius, HorizontalProgresRadius, HorizontalProgresRadius};
