package com.sdy.jitangapplication.widgets.swipecard;
...
public interface OnSwipeListener<T> {
     ...
     *                   CardConfig.SWIPING_NONE 为不偏左也不偏右 CardConfig.SWIPING_TOP 为向上
     */
     ...
     * @param t          该滑出卡片的数据
     * @param direction  卡片滑出的方向，CardConfig.TOP为上边滑出 CardConfig.SWIPED_LEFT 为左边滑出；CardConfig.SWIPED_RIGHT 为右边滑出
     */
